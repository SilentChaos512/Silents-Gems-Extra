...
import net.silentchaos512.extragems.setup.ExtraBlocks;
import net.silentchaos512.extragems.setup.ExtraItems;
...
public class ExtraGemsMod {
    ...
    public ExtraGemsMod() {
        ...
        ExtraBlocks.init(eventBus);
        ExtraItems.init(eventBus);
    }
